...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kfztfhm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kfztfhm.containers.anotherwebservice.com/
...
```
git clone git@github.com:slender232/container-kfztfhm.git
cd container-kfztfhm
```
...
```
docker attach container-kfztfhm
```
